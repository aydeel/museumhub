<div id="about">
    <h3>ABOUT</h3>
    <p>At Johor Museum Hub, we are dedicated to preserving history and culture through captivating exhibitions and interactive experiences.
    ...
    <div>
        <a href="#" class="fa  fa-caret-square-o-up"></a>
    </div>
